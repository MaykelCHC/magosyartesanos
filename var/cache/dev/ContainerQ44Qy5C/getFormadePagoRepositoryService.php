 ...
 */
class getFormadePagoRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FormadePagoRepository' shared autowired service.
     *
     * @return \App\Repository\FormadePagoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FormadePagoRepository.php';

        return $container->privates['App\\Repository\\FormadePagoRepository'] = new \App\Repository\FormadePagoRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
