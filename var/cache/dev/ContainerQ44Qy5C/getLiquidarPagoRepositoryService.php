 ...
 */
class getLiquidarPagoRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LiquidarPagoRepository' shared autowired service.
     *
     * @return \App\Repository\LiquidarPagoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LiquidarPagoRepository.php';

        return $container->privates['App\\Repository\\LiquidarPagoRepository'] = new \App\Repository\LiquidarPagoRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
