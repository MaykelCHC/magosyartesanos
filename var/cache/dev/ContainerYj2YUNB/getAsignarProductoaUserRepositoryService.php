 ...
 */
class getAsignarProductoaUserRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AsignarProductoaUserRepository' shared autowired service.
     *
     * @return \App\Repository\AsignarProductoaUserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AsignarProductoaUserRepository.php';

        return $container->privates['App\\Repository\\AsignarProductoaUserRepository'] = new \App\Repository\AsignarProductoaUserRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
