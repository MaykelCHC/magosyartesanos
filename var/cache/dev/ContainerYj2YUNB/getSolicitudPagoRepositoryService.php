 ...
 */
class getSolicitudPagoRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SolicitudPagoRepository' shared autowired service.
     *
     * @return \App\Repository\SolicitudPagoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SolicitudPagoRepository.php';

        return $container->privates['App\\Repository\\SolicitudPagoRepository'] = new \App\Repository\SolicitudPagoRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
