 ...
 */
class getVentaServicioRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VentaServicioRepository' shared autowired service.
     *
     * @return \App\Repository\VentaServicioRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VentaServicioRepository.php';

        return $container->privates['App\\Repository\\VentaServicioRepository'] = new \App\Repository\VentaServicioRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
