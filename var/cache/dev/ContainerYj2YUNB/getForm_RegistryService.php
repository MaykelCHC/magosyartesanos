...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\AsignarProductoaUserType' => ['privates', 'App\\Form\\AsignarProductoaUserType', 'getAsignarProductoaUserTypeService', true],
            'App\\Form\\FormadePagoType' => ['privates', 'App\\Form\\FormadePagoType', 'getFormadePagoTypeService', true],
            'App\\Form\\ProductoType' => ['privates', 'App\\Form\\ProductoType', 'getProductoTypeService', true],
            'App\\Form\\ServiciosType' => ['privates', 'App\\Form\\ServiciosType', 'getServiciosTypeService', true],
            'App\\Form\\SolicitarRecogidaType' => ['privates', 'App\\Form\\SolicitarRecogidaType', 'getSolicitarRecogidaTypeService', true],
            'App\\Form\\SolicitudPagoType' => ['privates', 'App\\Form\\SolicitudPagoType', 'getSolicitudPagoTypeService', true],
            'App\\Form\\UserType' => ['privates', 'App\\Form\\UserType', 'getUserTypeService', true],
            'App\\Form\\VentaProductoType' => ['privates', 'App\\Form\\VentaProductoType', 'getVentaProductoTypeService', true],
            'App\\Form\\VentaServicioType' => ['privates', 'App\\Form\\VentaServicioType', 'getVentaServicioTypeService', true],
            ...
            'App\\Form\\AsignarProductoaUserType' => '?',
            'App\\Form\\FormadePagoType' => '?',
            'App\\Form\\ProductoType' => '?',
            'App\\Form\\ServiciosType' => '?',
            'App\\Form\\SolicitarRecogidaType' => '?',
            'App\\Form\\SolicitudPagoType' => '?',
            'App\\Form\\UserType' => '?',
            'App\\Form\\VentaProductoType' => '?',
            'App\\Form\\VentaServicioType' => '?',
